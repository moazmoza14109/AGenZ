...
const SERVICE = {
  ...
  closingParagraphsKey: "media_buying.closing_paragraphs",
  bottomImage:
    "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=900&q=80",
};

export default function ServicePageV3() {
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="flex-1 min-w-0">
            ...
            <div
              className="mt-8 border rounded-2xl px-8 py-7 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm transition-colors duration-300"
              style={{
                background: isDark
