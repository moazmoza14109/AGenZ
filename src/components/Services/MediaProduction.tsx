...
const SERVICE = {
  titleKey: "media_production.title",
  paragraphsKey: "media_production.paragraphs",
  servicesLabelKey: "media_production.services_label",
  servicesListKey: "media_production.services_list",
  closingParagraphsKey: "media_production.closing_paragraphs",
};

export default function ServicePageV5() {
